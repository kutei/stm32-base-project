...
#define DCT4_DEFINE_TEST(suffix, input_type)                                                                                                 \
    ...
    {                                                                                                                                        \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                                                                \
            ...
            JTEST_COUNT_CYCLES(arm_dct4_##suffix(&dct4_inst_fut, (void *)transform_fft_input_fut, (void *)transform_fft_inplace_input_fut)); \
                                                                                                                                             \
            ...
            ref_dct4_##suffix(&dct4_inst_ref, (void *)transform_fft_input_ref, (void *)transform_fft_inplace_input_ref);                     \
                                                                                                                                             \
            /* Test correctness */                                                                                                           \
...
#define DCT4_FIXED_POINT_DEFINE_TEST(suffix, input_type, prefix)                                                                                 \
    ...
    {                                                                                                                                            \
        ...
        CONCAT(arm_cfft_radix4_instance_, suffix) cfft_inst_ref = {0};                                                                           \
                                                                                                                                                 \
        TEMPLATE_DO_ARR_DESC(                                                                                                                    \
            fftlen_idx, uint16_t, fftlen, transform_dct_fftlens, uint32_t i; float32_t normalize_f32 = ref_sqrt_f32((2.0f / (float32_t)fftlen)); \
            input_type normalize;                                                                                                                \
                                                                                                                                                 \
            /* Calculate normalized DCT4 value for input_type. */                                                                                \
            TEST_CONVERT_FLOAT_TO(&normalize_f32, &normalize, 1, input_type);                                                                    \
