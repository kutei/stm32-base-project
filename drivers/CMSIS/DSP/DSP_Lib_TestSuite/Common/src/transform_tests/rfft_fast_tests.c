...
#define RFFT_FAST_DEFINE_TEST(config_suffix, ifft_flag)                                                                                          \
    ...
    {                                                                                                                                            \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                                                                    \
            ...
            JTEST_COUNT_CYCLES(arm_rfft_fast_f32(&rfft_inst_fut, (void *)transform_fft_input_fut, (void *)transform_fft_output_fut, ifft_flag)); \
                                                                                                                                                 \
            ref_rfft_fast_f32(&rfft_inst_ref, (void *)transform_fft_input_ref, (void *)transform_fft_output_ref, ifft_flag);                     \
                                                                                                                                                 \
            /* Test correctness */                                                                                                               \
