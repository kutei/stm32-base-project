    ...
    {                                                                                                                                 \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                                                         \
            ...
            arm_rfft_init_##suffix(&rfft_inst_ref, (uint32_t)fftlen, ifft_flag, 1U);                                                  \
                                                                                                                                      \
            if (ifft_flag) {                                                                                                          \
                TRANSFORM_PREPARE_INVERSE_INPUTS(transform_fft_##suffix##_inputs, fftlen, input_type, fftlen * sizeof(input_type));   \
            ...
            JTEST_COUNT_CYCLES(arm_rfft_##suffix(&rfft_inst_fut, (void *)transform_fft_input_fut, (void *)transform_fft_output_fut)); \
                                                                                                                                      \
