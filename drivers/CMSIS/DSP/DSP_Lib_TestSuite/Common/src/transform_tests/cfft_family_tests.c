...
#define CFFT_TEST_NAME(fn_specifier, type_suffix, config_suffix) arm_cfft_##fn_specifier##_##type_suffix##_##config_suffix##_test
...
#define CFFT_FAMILY_DEFINE_TEST(fn_specifier, type_suffix, config_suffix, /* Delineate between test configs*/                                      \
    ...
    JTEST_DEFINE_TEST(CFFT_TEST_NAME(fn_specifier, type_suffix, config_suffix), CFFT_FN_NAME(fn_specifier, type_suffix))                           \
    {                                                                                                                                              \
        arm_cfft_##fn_specifier##_instance_##type_suffix cfft_inst_fut;                                                                            \
        arm_cfft_##fn_specifier##_instance_##type_suffix cfft_inst_ref;                                                                            \
                                                                                                                                                   \
        TEMPLATE_DO_ARR_DESC(fftlen_idx, uint16_t, fftlen, transform_##fn_specifier##_fftlens,                                                     \
                                                                                                                                                   \
                             ...
                             JTEST_COUNT_CYCLES(arm_cfft_##fn_specifier##_##type_suffix(&cfft_inst_fut, (void *)transform_fft_inplace_input_fut)); \
                                                                                                                                                   \
...
#define CFFT_FAMILY_DEFINE_ALL_TESTS(config_suffix, ifft_flag)                                                                    \
    /* Radix2 tests*/                                                                                                             \
    CFFT_FAMILY_DEFINE_TEST(radix2, q31, config_suffix, TRANSFORM_SNR_COMPARE_CMPLX_INTERFACE, TYPE_FROM_ABBREV(q31), ifft_flag); \
    CFFT_FAMILY_DEFINE_TEST(radix2, q15, config_suffix, TRANSFORM_SNR_COMPARE_CMPLX_INTERFACE, TYPE_FROM_ABBREV(q15), ifft_flag); \
    /* Radix4 tests*/                                                                                                             \
    CFFT_FAMILY_DEFINE_TEST(radix4, q31, config_suffix, TRANSFORM_SNR_COMPARE_CMPLX_INTERFACE, TYPE_FROM_ABBREV(q31), ifft_flag); \
    CFFT_FAMILY_DEFINE_TEST(radix4, q15, config_suffix, TRANSFORM_SNR_COMPARE_CMPLX_INTERFACE, TYPE_FROM_ABBREV(q15), ifft_flag)
/* /\* Mag tests*\/                                                  \ */
