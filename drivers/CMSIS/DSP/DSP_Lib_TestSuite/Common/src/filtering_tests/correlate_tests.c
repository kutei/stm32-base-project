...
#define CORRELATE_DEFINE_RAND_INPUT_ARR_DESCS(type_suffix)                                                                             \
    ARR_DESC_DEFINE_USING_ARR(TYPE_FROM_ABBREV(type_suffix), correlate_input_rand1_##type_suffix, CORRELATE_##type_suffix##_INPUTS, 0, \
                              CORRELATE_MAX_INPUT_ELTS);                                                                               \
                                                                                                                                       \
    ARR_DESC_DEFINE_USING_ARR(TYPE_FROM_ABBREV(type_suffix), correlate_input_rand2_##type_suffix, CORRELATE_##type_suffix##_INPUTS, 1, \
...
#define CORRELATE_DEFINE_ALL_INPUTS(type_suffix)                                                                                            \
    ARR_DESC_DEFINE(                                                                                                                        \
        ARR_DESC_t *, correlate_##type_suffix##_a_inputs, 4,                                                                                \
        CURLY(&correlate_input_zeros, &correlate_input_zeros, &correlate_input_rand1_##type_suffix, &correlate_input_rand1_##type_suffix)); \
...
#define CORRELATE_TEST_TEMPLATE(fut, fut_arg_interface, ref, ref_arg_interface, suffix, output_type)                                            \
    ...
    {                                                                                                                                           \
        TEMPLATE_DO_ARR_DESC(                                                                                                                   \
            input_idx, ARR_DESC_t *, input_ptr, correlate_##suffix##_a_inputs, void *input_a_ptr = input_ptr->data_ptr;                         \
            void *input_b_ptr = ARR_DESC_ELT(ARR_DESC_t *, input_idx, &(correlate_##suffix##_b_inputs))->data_ptr;                              \
                                                                                                                                                \
            TEMPLATE_DO_ARR_DESC(correlate_len_idx, uint32_t, correlate_len_a, correlate_lens_a,                                                \
                                 ...
                                 memset(filtering_output_fut, 0, (2 * CORRELATE_MAX_INPUT_ELTS) * sizeof(output_type));                         \
                                                                                                                                                \
                                 TEST_CALL_FUT_AND_REF(fut, fut_arg_interface(input_a_ptr, correlate_len_a, input_b_ptr, correlate_len_b), ref, \
