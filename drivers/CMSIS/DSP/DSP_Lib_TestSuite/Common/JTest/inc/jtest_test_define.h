 ...
 */
#define JTEST_TEST_STRUCT_NAME(test_fn) JTEST_STRUCT_NAME(JTEST_TEST_STRUCT_NAME_PREFIX, test_fn)

/**
 *  Define a #JTEST_TEST_t struct based on the given test_fn.
 */
#define JTEST_TEST_DEFINE_STRUCT(test_fn) JTEST_DEFINE_STRUCT(JTEST_TEST_t, JTEST_TEST_STRUCT_NAME(test_fn))

/**
 *  Declare a #JTEST_TEST_t struct based on the given test_fn.
 */
#define JTEST_TEST_DECLARE_STRUCT(test_fn) JTEST_DECLARE_STRUCT(JTEST_TEST_DEFINE_STRUCT(test_fn))
 ...
 */
#define JTEST_TEST_INIT(test_fn, fut, enable) JTEST_TEST_DEFINE_STRUCT(test_fn) = {JTEST_TEST_STRUCT_INIT(test_fn, fut, enable)}
...
/* Top-level Interface */
#define JTEST_DEFINE_TEST(...) JTEST_DEFINE_TEST_(PP_NARG(__VA_ARGS__), ##__VA_ARGS__)
...
/* Dispatch Cases*/
#define JTEST_DEFINE_TEST_1(_1) _JTEST_DEFINE_TEST(_1, JTEST_DEFINE_TEST_DEFAULT_FUT, JTEST_DEFINE_TEST_DEFAULT_ENABLE)

#define JTEST_DEFINE_TEST_2(_1, _2) _JTEST_DEFINE_TEST(_1, _2, JTEST_DEFINE_TEST_DEFAULT_ENABLE)
