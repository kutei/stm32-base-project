 ...
 */
#define JTEST_TEST_SET_FN(jtest_test_ptr, fn_ptr) JTEST_SET_STRUCT_ATTRIBUTE(jtest_test_ptr, test_fn_ptr, fn_ptr)

/**
 *  Specify a function under test (FUT) for the #JTEST_TEST_t struct.
 */
#define JTEST_TEST_SET_FUT(jtest_test_ptr, str) JTEST_SET_STRUCT_ATTRIBUTE(jtest_test_ptr, fut_str, str)
 ...
 */
#define JTEST_TEST_FLAG(jtest_test_ptr, flag_name) ((jtest_test_ptr)->flags.bits.flag_name)
 ...
 */
#define JTEST_TEST_SET_FLAG(jtest_test_ptr, flag_name) JTEST_TEST_XXX_FLAG(jtest_test_ptr, flag_name, SET)

/**
 *  Specification of #JTEST_TEST_XXX_FLAG to clear #JTEST_TEST_t flags.
 */
#define JTEST_TEST_CLR_FLAG(jtest_test_ptr, flag_name) JTEST_TEST_XXX_FLAG(jtest_test_ptr, flag_name, CLR)

/**
 *  Evaluate to true if the #JTEST_TEST_t is enabled.
 */
#define JTEST_TEST_IS_ENABLED(jtest_test_ptr) (JTEST_TEST_FLAG(jtest_test_ptr, enabled) == JTEST_TEST_FLAG_SET)
