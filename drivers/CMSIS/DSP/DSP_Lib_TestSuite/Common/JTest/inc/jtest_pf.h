 ...
 *  member.
 */
#define JTEST_PF_INC_PASSED(struct_pf_ptr, amount) JTEST_PF_INC_XXX(passed, struct_pf_ptr, amount)

/**
 *  Specialization of the #JTEST_PF_INC_XXX macro to increment the failed
 *  member.
 */
#define JTEST_PF_INC_FAILED(struct_pf_ptr, amount) JTEST_PF_INC_XXX(failed, struct_pf_ptr, amount)
 ...
 */
#define JTEST_PF_RESET_PASSED(struct_pf_ptr) JTEST_PF_RESET_XXX(passed, struct_pf_ptr)

/**
 *  Specialization of #JTEST_PF_RESET_XXX for the 'failed' member.
 */
#define JTEST_PF_RESET_FAILED(struct_pf_ptr) JTEST_PF_RESET_XXX(failed, struct_pf_ptr)
