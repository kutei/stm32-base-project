 ...
 */
#define JTEST_GROUP_STRUCT_NAME(group_fn) JTEST_STRUCT_NAME(JTEST_GROUP_STRUCT_NAME_PREFIX, group_fn)

/**
 *  Define a #JTEST_GROUP_t struct based on the given group_fn.
 */
#define JTEST_GROUP_DEFINE_STRUCT(group_fn) JTEST_DEFINE_STRUCT(JTEST_GROUP_t, JTEST_GROUP_STRUCT_NAME(group_fn))

/**
 *  Declare a #JTEST_GROUP_t struct based on the given group_fn.
 */
#define JTEST_GROUP_DECLARE_STRUCT(group_fn) JTEST_DECLARE_STRUCT(JTEST_GROUP_DEFINE_STRUCT(group_fn))

/**
 *  Contents needed to initialize a JTEST_GROUP_t struct.
 */
#define JTEST_GROUP_STRUCT_INIT(group_fn) group_fn, STR_NL(group_fn), JTEST_PF_MEMBER_INIT

/**
 *  Initialize the contents of a #JTEST_GROUP_t struct.
 */
#define JTEST_GROUP_INIT(group_fn) JTEST_GROUP_DEFINE_STRUCT(group_fn) = {JTEST_GROUP_STRUCT_INIT(group_fn)}
