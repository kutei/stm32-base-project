 ...
 */
#define JTEST_GROUP_SET_NAME(group_ptr, name) JTEST_SET_STRUCT_ATTRIBUTE(group_ptr, name_str, name)

#define JTEST_GROUP_SET_FN(group_ptr, fn_ptr) JTEST_SET_STRUCT_ATTRIBUTE(group_ptr, group_fn_ptr, fn_ptr)

/**
 *  Increment the number of tests passed in the JTEST_GROUP_t pointed to by
 *  group_ptr.
 */
#define JTEST_GROUP_INC_PASSED(group_ptr, amount) JTEST_PF_INC_PASSED(group_ptr, amount)

/**
 *  Increment the number of tests failed in the JTEST_GROUP_t pointed to by
 *  group_ptr.
 */
#define JTEST_GROUP_INC_FAILED(group_ptr, amount) JTEST_PF_INC_FAILED(group_ptr, amount)
