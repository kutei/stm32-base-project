...
#define INTRINSICS_SNR_COMPARE_INTERFACE(block_size, output_type)                                                                                   \
    do {                                                                                                                                            \
        TEST_CONVERT_AND_ASSERT_SNR(intrinsics_output_f32_ref, (output_type##_t *)intrinsics_output_ref, intrinsics_output_f32_fut,                 \
                                    (output_type##_t *)intrinsics_output_fut, block_size, output_type, INTRINSICS_SNR_THRESHOLD_##output_type##_t); \
    } while (0)
...
#define INTRINSICS_TEST_TEMPLATE_ELT1(functionName, dataType)                                                                  \
    ...
    {                                                                                                                          \
        ...
        JTEST_COUNT_CYCLES(for (i = 0; i < INTRINSICS_MAX_LEN; i++) {                                                          \
            *((dataType##_t *)intrinsics_output_fut + i) = functionName((dataType##_t)intrinsics_##dataType##_inputs[i]);      \
        });                                                                                                                    \
                                                                                                                               \
        for (i = 0; i < INTRINSICS_MAX_LEN; i++) {                                                                             \
            *((dataType##_t *)intrinsics_output_ref + i) = ref##functionName((dataType##_t)intrinsics_##dataType##_inputs[i]); \
        }                                                                                                                      \
                                                                                                                               \
    ...
    {                                                                                                                                \
        ...
        JTEST_COUNT_CYCLES(for (i = 0; i < INTRINSICS_MAX_LEN; i++) {                                                                \
            *((dataType##_t *)intrinsics_output_fut + i) =                                                                           \
                functionName((dataType##_t)intrinsics_##dataType##_inputs[i], (dataType##_t)intrinsics_##dataType##_inputs[i]);      \
        });                                                                                                                          \
                                                                                                                                     \
        for (i = 0; i < INTRINSICS_MAX_LEN; i++) {                                                                                   \
            *((dataType##_t *)intrinsics_output_ref + i) =                                                                           \
                ref##functionName((dataType##_t)intrinsics_##dataType##_inputs[i], (dataType##_t)intrinsics_##dataType##_inputs[i]); \
        }                                                                                                                            \
                                                                                                                                     \
        INTRINSICS_SNR_COMPARE_INTERFACE(INTRINSICS_MAX_LEN, dataType);                                                              \
                                                                                                                                     \
